...
import json
from Readers.SerialReaderMultiX3 import SerialReaderMultiX3Class
from threading import Thread
import time
import os
import sqlite3

class Consumer_MultiX3(WebsocketConsumer):
    ...
    def stopRec(self, file_name):
        ...
        cursor.execute('''
            CREATE TABLE IF NOT EXISTS FramesMultiX3 (
        ...
        match command:
            case  "start":
                try:
                    ...
                    self.serial_reader = SerialReaderMultiX3Class(interface)
