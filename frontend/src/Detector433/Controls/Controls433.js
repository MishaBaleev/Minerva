...
class Controls433 extends Component{
    ...
    actSq(){
        ...
        if (this.state.act_sq == ""){
            if (this.props.app.start_config433.int == ""){
        ...
        this.props.setCon433(slice_res)
    }
    changeInt(e){
    ...
    actRec(){
        ...
        this.props.setRec433(slice_res)
    }
    changeNote(value){
        this.setState(state => ({
            note: value
...
const mapDispatchToProps =  (dispatch) => {
    return {
        ...
        "setCon433": (data) => dispatch(setCon433(data)),
        "setRec433": (data) => dispatch(setRec433(data)),
    }
}
export default connect(mapStateToProps, mapDispatchToProps)(Controls433)